...
import {
  ...
  TIMELINE_BASE_LANE_HEIGHT,
  TIMELINE_BLOCK_PADDING,
  type TimelineAssignmentLayout,
...
const BASE_LANE_HEIGHT = TIMELINE_BASE_LANE_HEIGHT;
const HEADER_WIDTH = 260;
const GROUP_HEADER_HEIGHT = 36;
const TOP_AXIS_HEIGHT = 48;
const BLOCK_PADDING = TIMELINE_BLOCK_PADDING;
    ...
    for (const section of sections) {
      ...
      for (const lane of section.lanes) {
        ...
        const laneLayout = laneLayouts.get(lane.id) || {
          ...
          assignmentLayouts: new Map<string, TimelineAssignmentLayout>(),
        };
